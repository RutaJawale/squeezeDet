...
python ./src/eval.py \
  ...
  --image_set=train \
  --eval_dir=/rscratch/ruta/logs/squeezeDet-bc5682df57dab8589cbed5248ac06c0a905452bc/8.7/eval_train \
  --checkpoint_path=/rscratch/ruta/squeezeDet-bc5682df57dab8589cbed5248ac06c0a905452bc/data/model_checkpoints/squeezeDet/model.ckpt-87000 \
  --run_once=True \
  --net=squeezeDet \
  --gpu=0
